...
from obara_saika.angular_momentum import get_n_cartesian_accumulated, get_n_cartesian
...
class OverlapPWGTO:
    ...
    def get_overlap(self):
        ...
        S = np.zeros([self.basis.sh_dim, self.basis.sh_dim], dtype=complex)
...
class KineticPWGTO:
    ...
    def get_kinetic(self):
        ...
        T = np.zeros([self.basis.sh_dim, self.basis.sh_dim], dtype=complex)
...
class NucAttPWGTO:
    ...
    def get_nuclear_attraction(self):
        ...
        V = np.zeros([self.basis.sh_dim, self.basis.sh_dim], dtype=complex)
